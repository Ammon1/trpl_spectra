...
plt.xlim(0,6000)
sns.heatmap(np.log(spectra.iloc[10:1000,:].values),cmap='hsv')
sns.heatmap(np.log(spectra.iloc[100:1000,:].values),cmap='tab20b')
...
popt11=get_params(y_corr[1000:1100])
popt12=get_params(y_corr[1200:1300])
popt13=get_params(y_corr[1400:1500])
popt13=get_params(y_corr[1500:1600])
popt14=get_params(y_corr[1700:1800])
popt15=get_params(y_corr[1800:1900])
popt16=get_params(y_corr[1900:2000])
...
popt27=get_params(y_corr[3000:3100])
popt28=get_params(y_corr[3100:3200])
...
popt33=get_params(y_corr[1000:1200])
popt34=get_params(y_corr[1200:1400])
popt35=get_params(y_corr[1400:1600])
popt36=get_params(y_corr[1600:1800])
popt37=get_params(y_corr[1800:2000])
...
popt42=get_params(y_corr[2800:3000])
popt43=get_params(y_corr[3000:3200])
...
sig81=sin1(x,*popt18)
sig91=sin1(x,*popt19)
sig101=sin1(x,*popt20)
sig102=sin1(x,*popt21)
sig103=sin1(x,*popt22)
sig104=sin1(x,*popt23)
